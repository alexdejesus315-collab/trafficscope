    ...
    <footer className="relative bg-background border-t border-border">
      <div className="max-w-6xl mx-auto px-6 py-14 grid sm:grid-cols-2 md:grid-cols-5 gap-10">
        <div className="md:col-span-2">
          <FooterLogo />
          <p className="text-[13px] text-white mt-4 max-w-[240px] leading-relaxed">
            {t('footer.tagline')}
          </p>
          <div className="flex items-center gap-3 mt-6">
            {[Twitter, Linkedin, Instagram].map((Icon, idx) => (
              <a key={idx} href="#" className="h-9 w-9 rounded-full bg-secondary flex items-center justify-center text-white hover:!bg-primary/20 hover:!text-primary transition-all duration-200">
        ...
        <div>
          <div className="text-[12px] font-semibold text-white uppercase tracking-widest mb-4">
            {t('footer.product')}
          </div>
      ...
      <div className="relative border-t border-border">
        <div className="max-w-6xl mx-auto px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-[12px] text-white">
